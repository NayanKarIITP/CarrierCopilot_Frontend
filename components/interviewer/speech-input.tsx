    ...
    <div className="flex flex-col items-center gap-3 w-full">
      <button
        ...
        className={`
            ...
            ${isListening 
                ? "bg-red-500 shadow-red-500/40" 
                : "bg-indigo-600 hover:bg-indigo-700 shadow-indigo-600/40 dark:bg-indigo-500 dark:hover:bg-indigo-600"}
        `}
      >
        {isListening && (
           <>
      ...
      <p className={`text-xs font-bold uppercase tracking-wider transition-colors ${isListening ? 'text-red-500 animate-pulse' : 'text-gray-400 dark:text-gray-500'}`}>
        {isListening ? "Listening..." : "Click to Speak"}
      </p>
    </div>
  );
