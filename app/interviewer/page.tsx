...
//       {/* --- HEADER --- */}
//       <header className="bg-white dark:bg-card px-4 py-3 border-b border-gray-200 dark:border-border flex justify-between items-center z-30 shadow-sm shrink-0 h-16 transition-colors">
...
//               <p className="text-xs text-gray-500 dark:text-gray-400 font-medium truncate max-w-[120px]">{config.role}</p>
//             </div>
//           </div>
//         </div>
...
//               className={`p-2 rounded-full transition-colors ${ttsEnabled ? 'bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400' : 'bg-gray-100 dark:bg-muted text-gray-400 dark:text-gray-500'}`}
...
//               className="text-red-500 dark:text-red-400 text-xs font-bold uppercase hover:bg-red-50 dark:hover:bg-red-900/20 px-3 py-1.5 rounded-lg transition-colors"
//             >
//               End
//             </button>
//           </div>
...
//             {status === 'setup' && (
//               <div className="absolute inset-0 z-50 flex items-center justify-center p-4 bg-gray-50/90 dark:bg-black/80 backdrop-blur-sm lg:bg-black/60 lg:backdrop-blur-md transition-colors">
//                 <div className="w-full max-w-sm bg-white dark:bg-card rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 border border-gray-100 dark:border-border lg:border-none">
//                   <div className="p-6 md:p-8 space-y-6">
//                     <div className="text-center space-y-2">
//                       <div className="bg-indigo-100 dark:bg-indigo-900/30 w-12 h-12 rounded-full flex items-center justify-center mx-auto text-indigo-600 dark:text-indigo-400 mb-2">
//                         <Settings2 size={24} />
//                       </div>
//                       <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Session Setup</h2>
//                       <p className="text-sm text-gray-500 dark:text-gray-400">Configure your AI interviewer settings.</p>
//                     </div>

//                     <div className="space-y-4">
//                       <div>
//                         <label className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1 block">Target Role</label>
//                         <input
//                           className="w-full p-3 bg-gray-50 dark:bg-muted/20 border border-gray-200 dark:border-border rounded-xl text-sm font-medium focus:ring-2 focus:ring-indigo-500 outline-none transition-all text-gray-900 dark:text-white"
//                           value={config.role}
...
//                       </div>
//                       <div>
//                         <label className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1 block">Experience Level</label>
//                         <div className="grid grid-cols-3 gap-2">
//                           {['Junior', 'Mid-Level', 'Senior'].map((lvl) => (
//                             <button
//                               key={lvl}
//                               onClick={() => setConfig({ ...config, level: lvl })}
//                               className={`py-2.5 rounded-xl text-[10px] sm:text-xs font-bold border transition-all ${config.level === lvl ? 'bg-indigo-600 text-white border-indigo-600 shadow-md transform scale-105' : 'bg-white dark:bg-muted/10 text-gray-600 dark:text-gray-300 border-gray-200 dark:border-border hover:bg-gray-50 dark:hover:bg-muted/20'}`}
//                             >
//                               {lvl}
//                             </button>
//                           ))}
...
//                         disabled={loading}
//                         className="w-full bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-700 hover:to-violet-700 text-white py-3.5 rounded-xl font-bold text-sm flex justify-center items-center gap-2 shadow-lg shadow-indigo-200 dark:shadow-none transition-all active:scale-95"
//                       >
...
//                       className={`p-3 rounded-full transition-all duration-300 ${isListening ? 'bg-red-50 dark:bg-red-900/20 text-red-500 ring-2 ring-red-100 dark:ring-red-900 animate-pulse' : 'bg-gray-100 dark:bg-muted text-gray-500 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-muted/80'}`}
...
//                     className="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl disabled:opacity-50 disabled:cursor-not-allowed text-sm font-bold flex items-center gap-2 shadow-md shadow-indigo-200 dark:shadow-none transition-all active:scale-95"
//                   >
...
//             className={`flex flex-col items-center gap-1.5 p-2 rounded-xl w-full transition-all duration-300 ${mobileTab === 'interview' ? 'text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/20' : 'text-gray-400 dark:text-gray-500 hover:bg-gray-50 dark:hover:bg-muted/10'}`}
//           >
...
//             className={`flex flex-col items-center gap-1.5 p-2 rounded-xl w-full transition-all duration-300 ${mobileTab === 'analysis' ? 'text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/20' : 'text-gray-400 dark:text-gray-500 hover:bg-gray-50 dark:hover:bg-muted/10'}`}
//           >
