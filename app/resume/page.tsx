...
export default function ResumePage() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (responseData.success && responseData.data && responseData.data.length > 0) {
          ...
          // 🛠️ FLATTENING LOGIC (Handles DB nesting)
          const flatData = {
              ...latest,
              ...(latest.parsedResume || {}), 
              ...(latest.parsed || {}),     
  ...
  async function uploadResume(file: File) {
    ...
    try {
      ...
      // 🛠️ CRITICAL FIX: Extract 'resume' key specifically
...
//           // 🛠️ FLATTENING LOGIC (Handles DB nesting)
//           // We look for 'parsedResume' (Node backend) or 'parsed' (Python direct)
//           const flatData = {
//               ...latest,
//               ...(latest.parsedResume || {}), 
//               ...(latest.parsed || {}),     
...
//       // 🛠️ CRITICAL FIX: Aggressive Flattening 
//       // Your logs show the data is inside: responseData.data.parsedResume
//       const rootData = responseData.data || {};
      
//       const unifiedData = {
//           ...rootData,                    // Top level fields (pdf_url)
//           ...(rootData.parsedResume || {}), // Node.js often wraps it here
//           ...(rootData.data || {}),         // Python 'data' key
//           ...(rootData.parsed || {}),       // Legacy Python 'parsed' key
//           ...(rootData.analysis || {})      // Legacy Python 'analysis' key
//       };

//       console.log("✅ Unified Data for UI:", unifiedData);

//       // If score is 0, it means Python failed to extract text
//       if ((unifiedData.resume_score || 0) === 0) {
//           console.warn("⚠️ Warning: Score is 0. Resume might be an image scan.");
//       }
...
//         feedback: Array.isArray(unifiedData.feedback) ? unifiedData.feedback : [],
//         strengths: Array.isArray(unifiedData.strengths) ? unifiedData.strengths : [],
//         // Python sends 'weaknesses', UI expects 'improvements'
//         improvements: Array.isArray(unifiedData.weaknesses) ? unifiedData.weaknesses : []
//       });
